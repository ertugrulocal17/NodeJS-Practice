/*
1)country tablosunda bulunan country sütunundaki 
ülke isimlerinden 'A' karakteri ile başlayıp 'a' karakteri ile sonlananları sıralayınız.
*/
SELECT * FROM country
WHERE country
LIKE 'A%a';
/*
2)country tablosunda bulunan country sütunundaki 
...
ILIKE 'T___%'
OR title
~~* '_t__%'	-- ~~* işareti aynı zamanda ILIKE anlamına gelmektedir.
OR title
~~* '__t_%'
OR title
~~* '___t%';
